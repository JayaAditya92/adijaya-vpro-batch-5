...
# Example-13 (vectorization)# without taking an loop manipulating the array elememts.
# import numpy as np
# arr1 = np.array([1,2,3])
...
# # Example-13 (broadcasting)# without taking an loop manipulating the array elememts.
# import numpy as np
# arr1 = np.array([1,2,3])
# x = 10
# arr2 = arr1 + x
