...
# Example-3 () is optional, If we have one element comma is mandatory.
# t1 = 10,20,30,40,50
# print(t1)
# print(type(t1))
...
# # Example-6
# t1 = 10,20,30,40,50
# list1 = list(t1)            # converting to tuple - list
# list1[0] = 100
# t1 = tuple(list1)           # converting list - tuple
# print(t1)

# # Example-7 Compare to list tuple will occuipe less memory
# import sys
...
# # Example-9 search operation
# t1 = 10,20,30,40,50
# print(30 in t1)
# print(300 not in t1)
# print(300 in t1)

# Example-10 swaping two variables without third party variables
# num1, num2 ----> packing
#num2, num1---> un packin
# num1 = 200
# num2 = 100
...
#Indexing operations we need to practice.. other examples..
...
# ## Example-15 No need to write pre-defined logic it's recommended to use our own logic.
